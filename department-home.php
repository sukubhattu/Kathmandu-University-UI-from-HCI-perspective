...
<?php include 'header.php';?> 
    ...
    <main>
        <div class = "container">
            ...
            <div class="p-2"><h2>Department of Computer Science and Engineering<hr></h2></div>
                ...
                <div class = "col-md-3">
                    <div class="say">
                        <div class=" flex-column">
                            ...
                            <a href = "department-home.php"><div class="p-2 activeBack">Home</div></a>
