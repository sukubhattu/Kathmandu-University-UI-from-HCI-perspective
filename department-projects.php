        ...
        <div class = "container">
            ...
            <div class= "row">
                <div class = "col-md-3">
                    <div class=" flex-column">
                        <div class="say">
                            ...
                            <a href = "department-projects.php"><div class="p-2 activeBack">Projects</div></a>
                ...
                <div class = "col-md-9">
                    ...
                    <hr>
                    <p>
                        The department has following projects running.
                    </p>
                    <ul>
                        <li>Project 1</li>
                        <li>Project 2</li>
                    ...
                    <br>
                    <p>
                        The department has following projects completed.
                    </p>
                    <ul>
                        <li>Project 1</li>
                        <li>Project 2</li>
