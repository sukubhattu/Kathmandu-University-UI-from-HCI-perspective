        ...
        <div class = "container">
            ...
            <div class= "row">
                <div class = "col-md-3">
                    <div class=" flex-column">
                        <div class="say">
                            ...
                            <a href = "department-research.php"><div class="p-2 activeBack">Research</div></a>
                ...
                <div class = "col-md-9">
                    ...
                    <h4>Projects runned by Department</h4>
                    <hr>
                    <p>
                        The department has following research running.
                    </p>
                    <ul>
                        <li>Research 1</li>
                        <li>Research 2</li>
                    ...
                    <br>
                    <p>
                        The department has following research completed.
                    </p>
                    <ul>
                        <li>Research 1</li>
                        <li>Research 2</li>
